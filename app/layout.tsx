...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth" suppressHydrationWarning>
      ...
      <body className={`${inter.variable} ${playfair.variable} ${kalam.variable} font-sans antialiased bg-background text-foreground`}>
        <ThemeProvider
          attribute="class"
          defaultTheme="light"
          enableSystem={false}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid md:grid-cols-4 gap-8">
                <div className="space-y-4">
                  <h3 className="text-xl font-bold font-serif">Spice Life</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 text-gray-300">
                    <p>Alexandria: 1-703-667-0544</p>
                    <p>Gaithersburg: 1-240-428-1427</p>
                    <p>info@spicelifemd.com</p>
                  </div>
                </div>
                <div className="space-y-4">
