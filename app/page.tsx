  ...
  */
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          <Image
            ...
            width={200}
            height={200}
            className="absolute top-20 right-10 opacity-10 animate-bounce-gentle"
            aria-hidden="true"
          />
          <Image
            ...
            <div className="space-y-8 md:space-y-12">
              ...
              */}
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white font-serif leading-tight">
                Taste the
                <span className="block text-spice-500 mt-2 drop-shadow-lg">Authentic India</span>
              </h1>
              
              <p className="text-lg sm:text-xl md:text-2xl text-white max-w-4xl mx-auto leading-relaxed drop-shadow-md">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
                <ResponsiveOrderButton 
                  size="lg"
                  className="bg-spice-500 hover:bg-spice-600 text-white text-lg px-8 py-4 w-full sm:w-auto shadow-spice"
                />
                <Button
                  asChild
                  size="lg"
                  variant="outline"
                  className="border-brown-900 text-brown-900 hover:bg-brown-900 hover:text-white text-lg px-8 py-4 w-full sm:w-auto"
                >
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
              <div className="space-y-8 order-2 lg:order-1">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <ResponsiveOrderButton className="w-full sm:w-auto" />
                  <Button
                    asChild
                    variant="outline"
                    className="border-brown-900 text-brown-900 hover:bg-brown-900 hover:text-white w-full sm:w-auto"
                  >
              ...
              <div className="relative order-1 lg:order-2">
                <div className="relative">
                  <Image
                    ...
                    width={500}
                    height={600}
                    className="rounded-2xl shadow-brown-lg w-full object-cover"
                  />
                </div>
              </div>
            </div>
          ...
          <MotionSection delay={0.2}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map((value, index) => (
                <MotionSection key={value.title} delay={0.1 * index}>
                  <Card className="h-full border-0 shadow-spice hover:shadow-spice-lg transition-all duration-300 group">
      ...
      {/* Menu Section */}
      <section id="menu" className="py-20 md:py-32 bg-spice-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <MotionSection>
            <SectionHeader
              title="Our Menu"
            ...
            <div className="mb-16">
              <Card className="border-0 shadow-spice-lg overflow-hidden">
                <div className="h-[500px] lg:h-[600px] bg-gray-100 relative">
                  {/* Leaflet Map */}
                  <LeafletMapWrapper className="absolute inset-0 w-full h-full" />
          ...
          <MotionSection>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="order-2 lg:order-1">
                <Card className="border-0 shadow-spice-lg">
              ...
              <div className="space-y-8 order-1 lg:order-2">
                {LOCATIONS.map((location, index) => (
                  <MotionSection key={location.id} delay={0.1 * index}>
                    <Card className="border-0 shadow-spice">
